...
const Movie = (props) => {
    ...
    return(
        <div className="py-24 bg-sky-900 h-screen w-full">
            <div className="h-full flex flex-col my-4 sm:flex-row sm:justify-around items-center mx-20">
                ...
                <div className="my-2 sm:my-0 sm:ml-8 md:min-h-fit sm:block sm:min-w-[23%] sm:min-h-[50%] lg:min-h-fit lg:min-w-fit">
                    <img className="shadow-lg shadow-red-800 rounded-t-lg max-h-[75%] mx-8 align-middle" src={"https://image.tmdb.org/t/p/w300/"+data.poster_path} alt=""/>
                </div>
            </div>
        </div>
    )
