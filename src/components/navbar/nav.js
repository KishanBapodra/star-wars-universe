    ...
    return(
        <nav className={`fixed z-10 w-full px-2 sm:px-4 py-6 rounded bg-slate-900 bg-opacity-0 top-0 ${navBackground ? 'bg-opacity-100 text-white' : null}`} >
            <div className="px-0 lg:px-20 font-galaxy flex flex-wrap justify-between items-center w-full">
                ...
                <button data-collapse-toggle="mobile-menu" type="button" className="inline-flex items-center pb-4 p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white/80 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu" aria-expanded="false">
